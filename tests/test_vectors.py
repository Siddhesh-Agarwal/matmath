...
class Test(unittest.TestCase):
    ...
    def test_radd(self):
        vec1 = Vector(1, 2, 3)
        vec2 = Vector(4, 5, 6)
        self.assertEqual(vec2 + vec1, Vector(5, 7, 9))
    ...
    def test_rsub(self):
        vec1 = Vector(1, 2, 3)
        vec2 = Vector(4, 5, 6)
        self.assertEqual(vec2 - vec1, Vector(3, 3, 3))
    ...
    def test_component_retrieval(self):
        vec1 = Vector(1, 2, 3)
        self.assertTrue(vec1.x == 1)
        self.assertTrue(vec1.y == 2)
        self.assertTrue(vec1.z == 3)
        self.assertTrue(vec1.w == 0) # w is not defined - defaults to 0
